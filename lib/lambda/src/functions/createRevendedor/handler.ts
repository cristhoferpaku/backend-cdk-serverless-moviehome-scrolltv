...
import { CreateRevendedorService } from './services/createRevendedor.service';
import { CreateRevendedorRequest } from './dtos/createRevendedor.dto';
import {
  createOkResponse,
...
const FUNCTION_NAME = 'CreateRevendedorHandler';
...
export const handler = async (
  ...
  try {
    ...
    let requestData: CreateRevendedorRequest;
    try {
    ...
    const service = new CreateRevendedorService();
    const result = await service.createRevendedor(requestData, userId);

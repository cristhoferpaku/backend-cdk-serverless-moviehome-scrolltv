...
import { GetSeasonByIdService } from './services/getSeasonById.service';
import {
  GetSeasonByIdRequest,
  GetSeasonByIdResponse
} from './dtos/getSeasonById.dto';
import {
  createOkResponse,
...
const FUNCTION_NAME = 'GetSeasonByIdHandler';
...
export const handler = async (
  ...
  try {
    ...
    // Servicio
    const service = new GetSeasonByIdService();
    const result: GetSeasonByIdResponse = await service.getSeasonById({ id });

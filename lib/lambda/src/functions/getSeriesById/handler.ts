...
import { GetSerieByIdService } from './services/getSeriesById.service';
import {
  GetSerieByIdRequest,
...
const FUNCTION_NAME = 'GetSerieByIdHandler';
...
export const handler = async (
  ...
  try {
    ...
    // Servicio
    const service = new GetSerieByIdService();
    const result: GetSerieByIdResponse = await service.getSerieById({ id });

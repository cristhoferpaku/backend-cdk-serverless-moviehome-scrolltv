...
import { GetCollectionsByIdService } from './services/getCollectionById.service';
import {
...
const FUNCTION_NAME = 'GetCollectionsByIdHandler';
...
export const handler = async (
  ...
  try {
    ...
    // Servicio
    const service = new GetCollectionsByIdService();
    const result: GetCollectionsByIdResponse = await service.getCollectionsById({ id });

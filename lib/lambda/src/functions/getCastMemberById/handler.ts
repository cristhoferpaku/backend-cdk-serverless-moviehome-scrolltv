...
import { GetCastMemberByIdService } from './services/getCastMemberById.service';
import {
...
const FUNCTION_NAME = 'GetCastMemberByIdHandler';
...
export const handler = async (
  ...
  try {
    ...
    // Servicio
    const service = new GetCastMemberByIdService();
    const result: GetCastMemberByIdResponse = await service.getCastMemberById({ id });

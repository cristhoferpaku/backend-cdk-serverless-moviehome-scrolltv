...
import { UpdateMultimediaCategoriesService } from './services/updateMultimediaCategory.service';
import {
...
import { UpdateMultimediaCategoriesRequest } from './dtos/updateMultimediaCategory.dto';

const FUNCTION_NAME = 'UpdateMultimediaCategoriesHandler';
...
export const handler = async (
  ...
  try {
    ...
    const body = parseRequestBody<UpdateMultimediaCategoriesRequest>(event.body);
    ...
    const service = new UpdateMultimediaCategoriesService();
    const result = await service.updateMultimediaCategories(id, body);

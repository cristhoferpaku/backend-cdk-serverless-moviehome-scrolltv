...
import { RefreshTokenService } from './services/refreshTokenClient.service';
import { RefreshTokenClientRequest } from './dtos/refreshTokenClient.dto';
import { 
  createOkResponse, 
...
export const handler = async (
  ...
  try {
    ...
    // Parsear el body
    const refreshData = parseRequestBody<RefreshTokenClientRequest>(event.body);
    if (!refreshData) {

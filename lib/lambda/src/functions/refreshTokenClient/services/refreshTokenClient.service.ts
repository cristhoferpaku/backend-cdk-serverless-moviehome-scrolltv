...
import { RefreshTokenRepository } from '../repositories/refreshTokenClient.repo';
import { RefreshTokenClientResponse, RefreshTokenPayload } from '../dtos/refreshTokenClient.dto';
...
export class RefreshTokenService {
   ...
   */
  async refreshToken(refreshToken: string): Promise<RefreshTokenClientResponse | null> {
    try {

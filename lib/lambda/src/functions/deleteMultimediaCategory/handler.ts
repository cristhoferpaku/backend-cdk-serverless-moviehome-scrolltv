...
import { DeleteMultimediaCategoriesService } from './services/deleteMultimediaCategory.service';
import {
  createOkResponse,
...
const FUNCTION_NAME = 'DeleteMultimediaCategoriesHandler';
...
export const handler = async (
  ...
  try {
    ...
    const service = new DeleteMultimediaCategoriesService();
    const result = await service.deleteMultimediaCategories({ id });

...
import { DeleteCollectionsService } from './services/deleteCollection.service';
import {
  createOkResponse,
...
const FUNCTION_NAME = 'DeleteCollectionsHandler';
...
export const handler = async (
  ...
  try {
    ...
    const service = new DeleteCollectionsService();
    const result = await service.deleteCollections({ id });
